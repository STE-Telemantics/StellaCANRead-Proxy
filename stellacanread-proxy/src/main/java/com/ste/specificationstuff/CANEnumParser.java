...
public class CANEnumParser {
	...
	// Converts a CAN message "(1600453413.322000) canx 12d#01c90100a819d400" (which
	...
	// takes a CAN message "(1600453413.322000) canx 12d#01c90100a819d400" and
	// returns the string id. The id is represented by the characters after canx and
	// before the #. In this
	// example the id is denoted by 12d. Note: this is in hexadecimal. The id in
	// this case is equal to 301.
