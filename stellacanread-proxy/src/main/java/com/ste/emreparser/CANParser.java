...
public class CANParser {
    ...
    private static List<MessageObject> mList;

    public static List<MessageObject> getMessagesDefault() {
        if (mList == null) {
            mList = parseMessagesDefault();
        }
        return mList;
    }

    private static List<MessageObject> parseMessagesDefault() {
    ...
    public static void main(String[] args) {
        ...
        List<MessageObject> lpm = cp.parseMessagesDefault();
