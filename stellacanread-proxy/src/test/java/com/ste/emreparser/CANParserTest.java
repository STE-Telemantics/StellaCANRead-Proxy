...
public class CANParserTest {
    ...
    /**
     * Tests that check the parseMessagesDefault method and the state of
     * MessageObject
     */
    ...
    public void messageObjectHasDefaultValues() {
        ...
        // For each typedefObject in the list check whether they have equal amount of
        // arguments
    ...
    public void parseMessagesDefaultIncorrectID() {
        ...
        // Iterate through the list of message and make sure that id 3 is not among the
        // messages
        for (MessageObject mo : messageList) {
    ...
    public void parseMessagesDefaultHasName() {
        ...
        for (MessageObject mo : messageList) {
            // The condition that we're testing for, in this case that getName returns a
            // String of
            // length > 0
    ...
    public void parseMessagesDefaultEqualAmountOfFields() {
        ...
        // For each message, the amount of data types should be equal to the amount of
        // field names
        for (MessageObject mo : messageList) {
    ...
    public void parseTypedefsDefaultTypedefAmount() {
        ...
        // Parse typedefs.csv and assert that the expected amount of typedef objects are
        // present
